...
const removeCardFromCombination = (state:Player,combination:Combination,cardRecived:Card):void =>{
    ...
    if(combination.cards.length === 0){
        state.combinations = state.combinations.filter((combination:Combination)=>{
